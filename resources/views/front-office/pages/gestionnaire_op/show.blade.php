...
@section('title', 'Gestion cooperative')
@section('css')
@endsection
@section('component')
    <div class="row">
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between pb-0">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb ms-3">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ $profil->nom }} {{ $profil->prenom }}
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex flex-wrap">
                        <div>
                            <a href="{{ route('secretaire.utilisateurs.edit', $profil) }}" class="btn btn-success"><i
