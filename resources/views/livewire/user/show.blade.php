            ...
            <div class="card">
                <div class="card-body">
                    <dl class="mt-1 dl">
                        ...
                        @if ($user->operationPaysanes)
                            <dt>Cooperative paysane:</dt>
                            <dd>
                                {{ isset($user->operationPaysanes->libelle) ? $user->operationPaysanes->libelle : '---' }}<br>
                                {{ isset($user->operationPaysanes->localites->libelle) ? $user->operationPaysanes->localites->libelle : '' }}
                            </dd>
                        @endif
                        <dt>Role :</dt>
                        <dd>
