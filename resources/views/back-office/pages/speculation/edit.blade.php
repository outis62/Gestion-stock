                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body d-flex justify-content-center">
                            <dl class="dl">
                                <dt>Nom:</dt>
                                <dl>{{ $speculation->nom }}</dl>
                                <dt>Variete:</dt>
                                <dl>{{ $speculation->variete }}</dl>
                                <dt>Description:</dt>
                                <dl>{{ $speculation->description }}</dl>
                                <dt>Image:</dt>
                                <dl class="customer_name"><img src="{{ asset('storage/' . $speculation->image) }}"
                                        style="width: 5%" alt=""> </dl>

                            </dl>
                        </div>
                        <div class="card-footer d-flex justify-content-center gap-3">
                            <a href="{{ route('speculation.index') }}" type="button" class="btn btn-primary"> <i
                            ...
                            <a class="btn btn btn-success" data-bs-target="#showModal"
                                href="{{ route('speculation.show', $speculation->id) }}">
                                Modifier </a>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="{{ route('speculation.destroy', $speculation->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
