						...
						<div class="wrap-login100 p-6">
							<form class="login100-form validate-form" action="{{ route('login') }}" method="POST">
								...
								<span class="login100-form-title">
									<img src="{{asset('assets/assets/images/brand/logo_v1.png')}}" width="150" height="120"/>
								</span>
								...
								<div class="container-login100-form-btn">
                                    <button class="login100-form-btn btn-success" type="submit">Se Connecter</button>
								</div>
								<div class="text-center pt-3">
									<p class="text-dark mb-0">Vous n'avez pas un compte?<a href="register.html" class="text-success ml-1">S'inscrire</a></p>
								</div>
							</form>
						</div>
					</div>
